...
item2 = FlowerItem(2, "Gardenblue flower", "images/flower2.jpg",
                   "Delphiniums offer some of the truest-blue flowers in the garden.", 250)
...
item4 = FlowerItem(4, "Marigold", "images/flower4.jpg",
                   "Marigold is a flowering plant in the daisy family Asteraceae. It is probably native to southern Europe, though its long history of cultivation makes its precise origin unknown, and it may possibly be of garden origin.",
                   100)
item5 = FlowerItem(5, "Sun Flower", "images/flower5.jpg",
                   "Sunflowers originate in the Americas. They were first domesticated in what is now Mexico and the Southern United States.[10][11] Domestic sunflower seeds have been found in Mexico, dating to 2100 BCE",
                   400)
